...
import 'package:gatecheck/Categories/models/category_model.dart';
import 'package:gatecheck/Categories/utils/colors.dart';
...
backgroundColor:
category.isActive ? AppColors.success.withOpacity(0.12) : AppColors.danger.withOpacity(0.12),
